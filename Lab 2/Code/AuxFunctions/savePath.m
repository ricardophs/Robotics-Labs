function [path_m_ref, final_path] = savePath(resolution, start_p, end_p, number)
    ...
    save(sprintf('DataFiles/final_path_%d.mat', number), 'final_path');
    ...
    save(sprintf('DataFiles/path_%d.mat', number), 'path_m_ref');
